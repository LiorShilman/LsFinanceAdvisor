...
INSERT INTO "RelativeT" VALUES (2,75,72,10,1,1,8,'','','גרושים','גרושים , מצב כלכלי גרוע',2);
INSERT INTO "IncomesT" VALUES (1,'משכורת','24,000','','','','כולל כ - 50 שעות נוספות',1);
INSERT INTO "IncomesT" VALUES (2,'משכורת','9,000','','','','',2);
...
INSERT INTO "PersonT" VALUES (1,'ליאור',45,2,2,1,67,1,1);
INSERT INTO "PersonT" VALUES (2,'שרה',40,0,2,2,62,0,1);
INSERT INTO "FinanceAdvisorT" VALUES (1,'8,000','15,000',3.74,5.0,1);
INSERT INTO "IncomesExT" VALUES (1,'קרן דולרית','800','משיכה פעם בשנה של 5,000 דולר',1);
INSERT INTO "IncomesExT" VALUES (2,'הפרשות לפנסיה','6,105','פנסיה (מנורה) + ביטוח מנהלים (מגדל)',1);
INSERT INTO "IncomesExT" VALUES (3,'הפרשות לקרנות','2,413','קרן השתלמות - ילין לפידות',1);
...
INSERT INTO "RealEstatesT" VALUES (1,'דירה מגורים - 4 חדרים','1200000','550000','',1);
INSERT INTO "RealEstatesT" VALUES (2,'דירה להשקעה - 2 חדרים','950000','350000','',1);
INSERT INTO "VehiclesT" VALUES (1,'קיה פיקנטו','2015','37000','',1);
INSERT INTO "MortgagesT" VALUES (1,'דירה בבאר שבע 4 חדרים','ק.לצ','400,000','400,000','4.69','30','2072','345920400000','345920',1);
INSERT INTO "MortgagesT" VALUES (2,'דירה בבאר שבע 4 חדרים','פריים','275,000','275,000','5.65','30','1587','296320275000','296320',1);
INSERT INTO "MortgagesT" VALUES (3,'דירה בבאר שבע 4 חדרים','מ.לצ','325,000','325,000','4.74','25','1851','230300325000','230300',1);
INSERT INTO "LifeInsuranceT" VALUES (1,'מנורה - 892','1415000','',1);
INSERT INTO "LifeInsuranceT" VALUES (2,'מגדל - 4433','200,000','',2);
INSERT INTO "LifeLongCareInsurancesInInsuranceCompanyT" VALUES (1,'מנורה - 9004','13,500','13,500','13,500','13,500',1);
INSERT INTO "LifeLongCareInsurancesInInsuranceCompanyT" VALUES (2,'הראל','3000','3000','','',2);
...
INSERT INTO "LifeLongCareInsurancesInHealthT" VALUES (2,'מאוחדת','5,500','10,500',2);
...
INSERT INTO "OldPensionFundT" VALUES (1,'צהל','4,000','5,000','2,000',1);
INSERT INTO "PensionFundT" VALUES (1,'מנורה - 168','548,500','3,150','','9,000','6,000',1);
INSERT INTO "PensionFundT" VALUES (2,'מגדל חדשה 666','80,000','1,200','','2,500','1,500',2);
INSERT INTO "SocialSecurityBenefitsT" VALUES (1,'קצבת אלמן','4,470',1);
INSERT INTO "SocialSecurityBenefitsT" VALUES (2,'קצבת ילדים','725',1);
INSERT INTO "SocialSecurityBenefitsT" VALUES (3,'קצבת זקנה','2,300',1);
INSERT INTO "SocialSecurityBenefitsT" VALUES (4,'קצבת אלמן','4,470',2);
INSERT INTO "SocialSecurityBenefitsT" VALUES (5,'קצבת ילדים','725',2);
INSERT INTO "SocialSecurityBenefitsT" VALUES (6,'קצבת זקנה','2,520',2);
INSERT INTO "ManagerInsuranceT" VALUES (1,'מגדל - 366','496,500','2,700','495,000','192',1);
INSERT INTO "ManagerInsuranceT" VALUES (2,'מגדל מוקפאת 332','100,000','','','220',2);
INSERT INTO "PensionJointT" VALUES (1,'שכר דירה מודיעין','5,200','ימשיכו לגור בשכירות?',1);
